...
import { Language } from 'modules/localisation/language';
...
export class TranslateService {
  ...
  async getTranslateList(): Promise<Translate[]> {
    return await this.translateModel.find().select(["-updatedAt", "-createdAt"]).populate({ path: 'definitions', populate: { path: 'languageId' } }).exec();;
  }
